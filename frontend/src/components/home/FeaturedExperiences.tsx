...
export const FeaturedExperiences: React.FC = () => {
  ...
  return (
    <section
      ...
      data-cms-id="home-featured"
      data-cms-label="Featured"
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {experiences.map((exp, index) => (
            ...
            >
              <Link to={`/city/${exp.title.toLowerCase()}`} className="group block h-full">
                <Card
                  hoverEffect
                ...
                >
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-center mt-auto w-full">
                      <Button
                        size="sm"
                        className="w-full bg-brand-yellow hover:bg-[#E5A800] text-slate-900 rounded-md py-2 h-auto text-sm font-bold uppercase tracking-wide pointer-events-none"
                      >
                        Explore
                      </Button>
                    </div>
