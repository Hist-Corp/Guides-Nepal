    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          {/* Left Content */}
          <Reveal className="flex-1 space-y-10 z-10 max-w-2xl text-center md:text-left mx-auto md:mx-0">
                  ...
                  {cmsHero?.content?.heading ? (
                    <span className="text-[#547792]">
                      {accentText(
                        cmsHero.content.heading,
                        ['incredible locals'],
                        'text-[#F4B400] drop-shadow-sm'
                      )}
                    </span>
                  ) : (
                    <>
                      <span className="text-[#547792]">Enchanting experiences,</span>
                      <br />
              ...
              <Reveal variant="up" delay={140}>
                <p className="text-xl text-[#555555] font-medium max-w-lg leading-relaxed mx-auto md:mx-0">
                  {cmsHero?.content?.subtitle ? (
                    ...
                    <>
                      Book unique and memorable travel
            ...
            <Reveal variant="up" delay={380}>
              <div className="inline-flex items-center gap-4 pt-2 justify-center w-full md:justify-start md:w-auto">
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    to="/maila-dai"
                    className="bg-[#F4B400]/20 hover:bg-[#F4B400]/30 text-[#333333] text-sm font-bold pl-4 pr-1 py-1 rounded-full flex items-center gap-2 transition-colors shadow-sm border border-[#F4B400]/50"
                  >
                    Ask Maila Dai!
                    <SafeImage
                      src={NEPAL_IMAGES.guideMale}
                      alt="Maila Dai"
          ...
          {/* Right Image Collage */}
          <Reveal variant="left" delay={180} className="flex-1 w-full mt-8 lg:mt-0 relative">
            ...
            <div className="hidden lg:grid grid-cols-3 gap-4 h-[600px] items-center">
              ...
              <div className="col-span-1 h-full flex flex-col justify-center items-center relative">
                ...
                >
                  ...
                  <span className="text-sm font-bold text-[#333333] w-20 text-left">
                    {currentCity.name}
                  </span>
