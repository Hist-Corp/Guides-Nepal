...
export const kathmanduRichData: RichExperienceData[] = [
  {
    ...
    heroImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Dal_bhat.jpg/960px-Dal_bhat.jpg',
    host: {
      name: 'Apicha',
      image:
    ...
    description:
      'Ready to taste the best food in Kathmandu? Satisfy your cravings for local food and culture with highlights along the way, together with a foodie host. Enjoy 10 delicious and typical tastings that range from sweet to savory as well as drinks on a tasty food tour in Kathmandu.',
    tourStructure: {
      steps: [
    ...
    exploration: {
      ...
      description:
        "We'll navigate the bustling streets of Kathmandu, diving into local markets and hidden alleys to find the most authentic flavors. This isn't just about food; it's about the culture behind it.",
      points: [
    ...
    atmosphere:
      'We keep it casual and fun! Think of it as a walking dinner party with a friend who knows exactly where to go.',
    hiddenGems:
      "Between bites, we'll slip into quiet courtyards and visit small shrines that most tourists walk right past.",
    city: 'Kathmandu',
    price: 45,
    duration: '3 hours',
    type: 'Food Tour',
  ...
  },
  {
    ...
    heroImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Momo_nepal.jpg/960px-Momo_nepal.jpg',
    host: {
      name: 'Jojo',
      image:
    ...
    description:
      'Want to get a real local taste of Kathmandu? Give it a taste and find out on this street food private tour in Kathmandu! Join a local host expert in food and culture on a tour that will satisfy your cultural cravings.',
    tourStructure: {
      steps: [
    ...
    exploration: {
      title: 'How we explore the city',
      description:
        'A focused culinary journey through the heart of the city, targeting the absolute must-try dishes.',
      points: [
  ...
  },
  {
    ...
    heroImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Three_saddhus_at_Kathmandu_Durbar_Square.jpg/960px-Three_saddhus_at_Kathmandu_Durbar_Square.jpg',
    host: {
      name: 'Artty',
      image:
    ...
    description:
      "Want to see the best of Kathmandu? We got you covered. But as you can expect from a Guides Nepal experience, the real excitement is its hidden gems. Join your favorite local and get a feeling of the city's real vibe.",
    tourStructure: {
      steps: [
    ...
    exploration: {
      title: 'How we explore the city',
      description:
        "We mix the big sights with the secret spots. You'll see the famous temples, but also the quiet corners where daily life happens.",
      points: [
    ...
    atmosphere:
      "Relaxed and full of stories. It's like walking with an old friend who wants to show you their neighborhood.",
  ...
  },
  {
    ...
    heroImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Boudha_Stupa_2018_04.jpg/960px-Boudha_Stupa_2018_04.jpg',
    host: {
      name: 'Piyawee',
      image:
    ...
    description:
      "You've probably heard that Kathmandu is well-known for Buddhism and its monks, but do you know the stories and origin behind it? On this private city tour, you are in for a cultural treat!",
    tourStructure: {
      steps: [
    ...
    exploration: {
      title: 'How we explore the city',
      description:
        'A spiritual journey through the Buddhist heritage of the valley. Respectful, insightful, and peaceful.',
      points: [
  ...
  },
  {
    ...
    description:
      'Picture this, a night out in Kathmandu hopping from hot spot to hot spot, discovering local nightlife while tasting typical local drinks perfectly paired with delicious local bites.',
    tourStructure: {
      steps: [
    ...
    exploration: {
      title: 'How we explore the city',
      description:
        'We hit the streets when the sun goes down to see a different side of Kathmandu.',
      points: [
  ...
  },
  {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1740&q=80',
    host: {
      name: 'Chef Hnoi',
      image:
    ...
    description:
      'Imagine this: a scenic road trip from Kathmandu to explore Nagarkot with stops along the way to discover viewpoints, villages, incredible nature, and cultural gems.',
    tourStructure: {
      steps: [
  ...
  },
  {
    ...
    heroImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Historic_Pagoda_Style_Architecture_in_Kathmandu_Durbar_Square-IMG_4069.jpg/960px-Historic_Pagoda_Style_Architecture_in_Kathmandu_Durbar_Square-IMG_4069.jpg',
    host: {
      name: 'Natcha',
      image:
    ...
    description:
      'Embark on a Ancient city of Bhaktapur day trip outside of Kathmandu where many treasures, insights, and stories are waiting. Let a local host show you around.',
    tourStructure: {
      steps: [
    ...
    exploration: {
      title: 'How we explore the city',
      description:
        'Bhaktapur is a living museum. We walk its brick-paved streets to travel back in time.',
      points: [
  ...
  },
  {
    ...
    description:
      "The way to a city's heart it's through its food! And on this private food tour, you'll get to know Kathmandu through its cuisine and the tastings favorite of the locals.",
    tourStructure: {
      steps: [
  ...
  },
  {
    ...
    heroImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Kathmandu_Durbar_Square%2C_Shiva_Parvati_Temple%2C_Nepal_%28edit%29.jpg/960px-Kathmandu_Durbar_Square%2C_Shiva_Parvati_Temple%2C_Nepal_%28edit%29.jpg',
    host: {
      name: 'Agrindra',
      image:
    ...
    description:
      'Ready for a jam-packed tour, full of history, culture, stories, and sights? Checkmark from your travel bucket list all your must-sees of Kathmandu.',
    tourStructure: {
      steps: [
  ...
  },
  {
    ...
    heroImage:
      'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1740&q=80',
    host: {
      name: 'Sudarat',
      image:
    ...
    description:
      'Embark on a Chandragiri Hills day trip outside of Kathmandu. Ride the cable car for panoramic views of the Himalayas.',
    tourStructure: {
      steps: [
