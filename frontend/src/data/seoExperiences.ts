...
export const seoExperiences: Record<string, SeoExperienceData> = {
  'amsterdam-highlights': {
    ...
    author: {
      ...
      image:
        'https://images.unsplash.com/photo-1563492065599-3520f775eeed?auto=format&fit=crop&w=400&q=80',
    ...
    highlights: {
      ...
      description:
        'When walking the streets of Amsterdam, we follow a route designed to show you the authentic lifestyle of the locals.',
      items: [
    ...
    cancellation:
      'Free cancellation for 48 hours. Cancel before 24 hours of the start date for a partial refund.',
    reviews: [
      {
        id: 1,
        ...
        rating: 5,
        content:
          "Great location and amazing guide! Anne was very helpful and showed us parts of the city we would never have found on our own. Very clean and organized tour. The hidden courtyards were absolutely magical, and the history Anne shared brought them to life. \n\nWe also stopped at a small local bakery that I would have walked right past. The apple pie there was the best I've ever had! Highly recommend this tour for anyone wanting to see the real Amsterdam.",
      },
      {
        id: 2,
        author: 'Michael Chen',
    ...
    similarListings: [
      ...
      {
        title: '7 Ways to Live Like a Local in Amsterdam',
        image:
      ...
      {
        title: 'Museums and Gems: How to Avoid Crowds',
        image:
  ...
  'bangkok-food': {
    ...
    description:
      'Explore the vibrant street food scene of Bangkok. We visit hidden stalls and famous vendors.',
    tourStructure: {
      title: 'Food Journey',
      steps: [
  ...
  'bangkok-highlights': {
    ...
    highlights: {
      ...
      items: ['Reclining Buddha', 'Longtail boat ride', 'Wat Arun', 'Amulet market', 'River lunch'],
    },
