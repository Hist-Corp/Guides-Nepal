          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                Explore historic <span className="text-[#213448]">Lalitpur</span>{' '}
                <br className="hidden md:block" />
                with our locals
              </h1>

              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                Known as the City of Fine Arts. Discover hidden courtyards, ancient temples, and
                living heritage with a local expert.
              </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
            ...
            {[
              {
                name: 'Emma',
                review:
                  'The history walk through Patan Durbar Square was eye-opening. Our guide knew so many hidden details.',
                host: 'Sina',
              ...
              },
              {
                name: 'Michael',
                review:
                  'Visiting the Golden Temple with a local was a spiritual experience. Highly recommend!',
                host: 'Raj',
              ...
              },
              {
                name: 'Sophia',
                review:
                  'The art workshop was the highlight of our trip. We made our own small souvenirs!',
                host: 'Priya',
        ...
        <div className="mb-24" id="locals-section">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Meet our <span className="text-[#213448]">Lalitpur locals</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Artisans, historians, and foodies ready to share their heritage.
            </p>
          </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Lalitpur, also known as Patan, is the center of traditional Nepalese art and
                  architecture. Visit the workshops of master craftsmen who have been preserving
                  ancient techniques of wood carving, metal casting, and stone sculpting for
                  generations.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  You can even try your hand at some of these crafts in a private workshop with a
                  local artisan.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Lalitpur is famous for its rich culinary heritage. Dive into a traditional Newari
                  feast with dishes like Bara, Chatamari, and Yomari. Our food tours take you to the
                  best local eateries hidden in the narrow alleyways.
                </p>
                <div className="bg-[#FFF0E6] p-6 rounded-2xl border-l-4 border-[#213448]">
                  ...
                  <p className="text-sm text-gray-700">
                    Yomari (sweet dumplings) - a Patan specialty.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Lalitpur is a living museum. Walking through its streets feels like stepping back in
              time. The city is renowned for its intricate architecture, vibrant festivals, and
              skilled artisans.
            </p>
            <p>
              The <strong className="text-gray-900">Patan Durbar Square</strong> is a UNESCO World
              Heritage site that you simply cannot miss. The{' '}
              <strong className="text-gray-900">Patan Museum</strong> is often cited as one of the
              best museums in South Asia.
            </p>
            <p>
              Don't forget to visit the{' '}
              <strong className="text-gray-900">Golden Temple (Hiranya Varna Mahavihar)</strong>, a
              masterpiece of Buddhist architecture. And for a panoramic view of the Kathmandu
              Valley, head to the surrounding hills.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              'Metal craft Nepal',
              'Heritage walk Lalitpur',
              'Buddhism in Patan',
              'Rato Machindranath festival',
              'Mangal Bazaar shopping',
              'Traditional pottery',
            ].map((tag, i) => (
              <a
                key={i}
