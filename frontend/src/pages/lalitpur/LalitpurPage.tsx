      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="mb-24">
           <div className="relative h-[400px] rounded-3xl overflow-hidden mb-16 group cursor-pointer">
              <img src="https://images.unsplash.com/photo-1533105079780-92b9be482077777?auto=format&fit=crop&w=400&q=80" className="w-full h-full object-cover brightness-[0.6] group-hover:scale-105 transition-transform duration-700" />
           ...
           <div className="space-y-24">
              ...
              <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
                 <div className="md:w-1/2">
                    <img src="https://images.unsplash.com/photo-1528181304800-259b08848526?auto=format&fit=crop&w=400&q=80" className="rounded-3xl shadow-xl w-full" />
                 </div>
                 <div className="md:w-1/2">
