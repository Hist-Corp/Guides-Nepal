...
const cookingClassLocals = [
  {
    name: 'Chef Sita',
    title: 'Traditional Newari Cooking Expert',
    reviews: 892,
    languages: 'English・Nepali',
  },
  {
    name: 'Araya',
    title: 'The Culinary and Culture Admirer',
    reviews: 420,
    languages: 'English・French・Nepali',
  },
  {
    name: 'Chef Jekky',
    title: 'Chef Jekky and The Team',
    reviews: 195,
    languages: 'English・French・Nepali',
  },
  {
    name: 'Wasana',
    title: 'The Food Maniac & Nepali Cooking Class',
    reviews: 199,
    languages: 'English・Nepali',
  },
  {
    name: 'Maya',
    title: 'Organic Farm to Table Specialist',
    reviews: 567,
    languages: 'English・Nepali',
  },
  {
    name: 'Raju',
    title: 'Momo Master & Street Food Guide',
    reviews: 334,
    languages: 'English・Nepali',
  },
  {
    name: 'Priya',
    title: 'Vegetarian Nepali Cuisine Expert',
    reviews: 278,
    languages: 'English・Hindi・Nepali',
  },
  {
    name: 'Bikash',
    title: 'Traditional Thakali Kitchen',
    reviews: 445,
    languages: 'English・Nepali',
  },
  {
    name: 'Anita',
    title: 'Home Cooking & Family Recipes',
    reviews: 189,
    languages: 'English・Nepali',
  },
  {
    name: 'Tenzin',
    title: 'Tibetan-Nepali Fusion Chef',
    reviews: 312,
...
const cookingTours = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1567337710282-00832b415979?auto=format&fit=crop&w=1740&q=80',
    rating: 4.9,
    reviews: 445,
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1740&q=80',
    rating: 4.7,
    reviews: 334,
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&w=1740&q=80',
    rating: 4.8,
    reviews: 723,
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                Learn to cook authentic Nepali dishes with experienced local chefs. From momo
                dumplings to traditional dal bhat, discover the secrets of Nepali cooking in a
                hands-on experience.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4 translate-y-8">
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg">
                    <img
                      src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?auto=format&fit=crop&w=1740&q=80"
                ...
                <div className="space-y-4">
                  <div className="aspect-square rounded-2xl overflow-hidden shadow-lg">
                    <img
                      src="https://images.unsplash.com/photo-1610701596007-11502861dcfa?auto=format&fit=crop&w=1740&q=80"
                      alt="Momo Making"
                      className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                    />
                  </div>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20 text-center">
          ...
          <div className="flex flex-col items-center group">
            ...
            <p className="text-gray-500 max-w-xs">
              Always private. It's just you and your local host. No strangers, no groups.
            </p>
          </div>
          <div className="flex flex-col items-center group">
            <div className="w-20 h-20 rounded-full bg-[#FFF0E6] flex items-center justify-center text-[#213448] mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-gray-500 max-w-xs">
              Let your local host tailor the experience completely to your wishes.
            </p>
          </div>
        </div>
        ...
        <div className="full-width bg-[#E0F2FE] -mx-4 md:-mx-[max(1rem,calc((100vw-80rem)/2))] px-4 md:px-[max(1rem,calc((100vw-80rem)/2))] py-20 mb-24">
          <div className="text-center mb-12">
            <span className="text-[#213448] font-bold uppercase tracking-wider text-sm block mb-2">
              Experiences
            </span>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Dal_bhat.jpg/960px-Dal_bhat.jpg"
                alt="Dal Bhat"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Master the Art of Dal Bhat
                </h3>
                <p className="text-gray-600 mb-4">
                  A private cooking class in Kathmandu is the easiest and most authentic way to
                  learn Nepal's national dish. Dal Bhat isn't just food—it's a cultural experience
                  that brings families together every day.
                </p>
                <p className="text-gray-600">
                  Choose one of our local hosts, who can truly give you an experience worth
                  remembering. They'll show you how to perfectly season the lentils, cook the rice
                  to fluffy perfection, and prepare the accompanying vegetables and pickles.
                </p>
              </div>
            </div>
            {/* Card 2: Momo */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Momo_nepal.jpg/960px-Momo_nepal.jpg"
                alt="Momo Making"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Perfect the Momo Folding Technique
                </h3>
                <p className="text-gray-600 mb-4">
                  The most fun thing to learn in Kathmandu is the art of momo making. These
                  delicious dumplings are a staple of Nepali cuisine, and mastering the folding
                  technique is both challenging and rewarding.
                </p>
                <div className="bg-gray-100 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800 mb-2">Must Try Fillings</h4>
                  <ul className="list-disc list-inside text-gray-600">
                    <li>
                      Chicken, Buff (Buffalo), Vegetable, Cheese, Chocolate (for dessert momos!)
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=1740&q=80"
                alt="Spice Market"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Explore Aromatic Spice Markets
                </h3>
                <p className="text-gray-600 mb-4">
                  The Local Spice Markets are a joy for the senses and essential for authentic
                  Nepali cooking! Add them to your cooking class experience and you won't regret it!
                  You will find everything from fresh turmeric to aromatic cardamom.
                </p>
                <p className="text-gray-600">
                  Most of the markets are really crowded, but that's part of their charm. Your host
                  will help you navigate all the spices and give insights on which ones to use for
                  different dishes.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=1740&q=80"
                alt="Newari Food"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Discover Ancient Newari Recipes
                </h3>
                <p className="text-gray-600 mb-4">
                  There are quite a few culinary highlights worth learning in Kathmandu, but Newari
                  cuisine is surely a must-try! These ancient recipes have been passed down through
                  generations and represent the rich cultural heritage of the Kathmandu Valley.
                </p>
        ...
        <div className="py-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12">
            Why do Guides Nepal love what they do?
          </h2>
        ...
        <div className="py-20 bg-gray-50 rounded-3xl">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">
              Best cooking experiences in Nepal
            </h2>
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>
                Nepali cuisine is a delightful blend of flavors, spices, and traditions that will
                tantalize your taste buds! From the aromatic dal bhat to the delicate momo
                dumplings, every dish tells a story of cultural heritage and family traditions.
              </p>
              <p>
                Start your culinary journey with Dal Bhat, the national dish that powers Nepal. This
                nutritious combination of lentil soup, rice, and vegetables is more than just
                food—it's a daily ritual that brings families together.
              </p>
              <p>
                If you're a fan of dumplings, you're in for a treat! Momo making is an art form in
                Nepal. These juicy dumplings, filled with spiced meat or vegetables, are steamed to
                perfection and served with fiery tomato chutney.
              </p>
              <p>
                Want to explore beyond the basics? Discover Newari cuisine, the indigenous food
                culture of the Kathmandu Valley. From spicy choila meat to sweet yomari dumplings,
                these ancient recipes offer a taste of authentic Nepali heritage.
              </p>
              <p>
                No matter what your culinary interests are, there's always something delicious to
                learn in Nepal. And with a Guides Nepal cooking class, you can customize your
                experience to focus on your favorite flavors. So what are you waiting for? Book your
                private cooking class today and discover the magic of Nepali cuisine!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {[
                ...
                'Kathmandu food experience',
                'Nepali chef guide',
                'Hands-on cooking class',
                'Nepali kitchen basics',
                'Traditional cooking methods',
                'Nepali family cooking',
                'Cultural food tour',
                'Nepali spices',
                'Kathmandu culinary tour',
                'Cooking vacation Nepal',
                'Food tour Kathmandu',
        ...
        <div className="mb-24">
          <div className="flex items-end justify-between mb-8">
            <div>
              <h3 className="text-[#213448] font-bold uppercase tracking-wider text-sm mb-2">
                Don't miss out
              </h3>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Top Rated Cooking Classes
              </h2>
            </div>
            <button
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex -space-x-3">
                        ...
                        />
                        <div className="w-10 h-10 rounded-full border-2 border-white bg-white/20 backdrop-blur-md flex items-center justify-center text-xs font-bold">
                          +12
                        </div>
                      </div>
        ...
        <div className="full-width bg-[#FFF0E6] -mx-4 md:-mx-[max(1rem,calc((100vw-80rem)/2))] px-4 md:px-[max(1rem,calc((100vw-80rem)/2))] py-20 mb-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Travelers love our cooking hosts
            </h2>
            <p className="text-gray-600">
              Reviews from guests about our cooking classes and local hosts
            </p>
          </div>
            ...
            {[
              {
                name: 'Sarah',
                review:
                  'Chef Sita was amazing! She taught us how to make authentic dal bhat and momos. The market visit was fascinating, and we learned so much about Nepali spices and ingredients.',
                host: 'Chef Sita',
              ...
              },
              {
                name: 'Michael',
                review:
                  "The momo making workshop with Raju was incredible! He made it so easy to follow along, and the dumplings we made were delicious. Best cooking class I've ever taken!",
                host: 'Raju',
              ...
              },
              {
                name: 'Emma',
                review:
                  "Araya's cooking class was the highlight of our Nepal trip! She welcomed us into her home like family. The Newari feast we prepared together was absolutely delicious.",
                host: 'Araya',
              ...
              <div key={i} className="bg-white p-8 rounded-3xl shadow-sm relative">
                ...
                <p className="text-gray-800 font-medium italic mb-8 leading-relaxed">
                  "{review.review}"
                </p>
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#213448] font-bold uppercase">
                      About local {review.host}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mb-24" id="locals-section">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Explore cooking classes with our{' '}
              <span className="text-[#213448]">incredible local chefs</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Learn about their personal cooking stories and find out how you can master Nepali
              cuisine with locals who know the flavors best.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            {displayedLocals.map((local, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-lg text-gray-900 mb-1 group-hover:text-[#213448] transition-colors">
                  {local.name}
                </h3>
                <p className="text-xs text-gray-500 uppercase tracking-wide mb-2 text-center line-clamp-1 px-2">
                  {local.title}
                </p>
        ...
        <div className="mb-24">
          <div className="relative rounded-2xl overflow-hidden shadow-lg group cursor-pointer">
            <img
              src="https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=1740&q=80"
            ...
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <p className="text-lg">
                Experience authentic Nepali hospitality and traditional cooking methods.
              </p>
            </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1609501676725-7186f017a4b7?auto=format&fit=crop&w=1740&q=80"
            ...
            <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1617093727343-374698b1b08d?auto=format&fit=crop&w=1740&q=80"
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1554188248-986adbb73be4?auto=format&fit=crop&w=1740&q=80"
                  className="rounded-3xl shadow-xl w-full"
                />
              </div>
              <div className="md:w-1/2">
            ...
            <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1552832230-c0197dd311b5?auto=format&fit=crop&w=1740&q=80"
                  className="rounded-3xl shadow-xl w-full aspect-[4/3] object-cover"
                />
              </div>
              <div className="md:w-1/2">
        ...
        <div className="mb-24 pt-16 border-t border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              {
                title: 'A fair income',
                desc: 'Our hosts set their own price.',
                icon: <ShieldCheck className="w-8 h-8" />,
              },
              {
                title: 'Passion for culture',
                desc: 'Sharing their heritage with you.',
                icon: <Heart className="w-8 h-8" />,
              },
              {
                title: 'Eco-friendly',
                desc: 'Low impact, high connection.',
                icon: <Users className="w-8 h-8" />,
              },
              {
                title: 'Unique skills',
                desc: 'From chefs to historians.',
                icon: <Star className="w-8 h-8" />,
              },
              {
                title: 'Flexible schedule',
                desc: 'Tours that fit your time.',
                icon: <Clock className="w-8 h-8" />,
              },
              {
                title: 'Global community',
                desc: 'Connecting the world.',
                icon: <Users className="w-8 h-8" />,
              },
            ].map((item, i) => (
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#213448] mb-6">
            Best cooking experiences in Nepal
          </h2>
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Nepali cuisine is a delightful blend of flavors, spices, and traditions that will
              tantalize your taste buds! From the aromatic dal bhat to the delicate momo dumplings,
              every dish tells a story of cultural heritage and family traditions.
            </p>
            <p>
              Start your culinary journey with <strong className="text-gray-900">Dal Bhat</strong>,
              the national dish that powers Nepal. This nutritious combination of lentil soup, rice,
              and vegetables is more than just food—it's a daily ritual that brings families
              together.
            </p>
            <p>
              If you're a fan of dumplings, you're in for a treat!{' '}
              <strong className="text-gray-900">Momo making</strong> is an art form in Nepal. These
              juicy dumplings, filled with spiced meat or vegetables, are steamed to perfection and
              served with fiery tomato chutney.
            </p>
            <p>
              Want to explore beyond the basics? Discover{' '}
              <strong className="text-gray-900">Newari cuisine</strong>, the indigenous food culture
              of the Kathmandu Valley. From spicy choila meat to sweet yomari dumplings, these
              ancient recipes offer a taste of authentic Nepali heritage.
            </p>
            <p>
              No matter what your culinary interests are, there's always something delicious to
              learn in Nepal. And with a Guides Nepal cooking class, you can customize your
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <h3 className="text-[#213448] font-bold text-sm uppercase tracking-wider">
              Related keywords
            </h3>
          </div>
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              <a
                key={i}
                href="#"
                className="px-3 py-1.5 bg-[#FFF0E6] text-[#213448] text-xs font-bold rounded hover:bg-[#213448] hover:text-white transition-colors"
              >
                {tag}
              </a>
            ))}
