          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                Relax in <span className="text-[#213448]">Pokhara</span>{' '}
                <br className="hidden md:block" />
                with our locals
              </h1>

              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                From the serene Phewa Lake to the stunning Annapurna range. Discover the natural
                beauty of Pokhara with a local friend.
              </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
            ...
            {[
              {
                name: 'Sarah',
                review:
                  'The sunrise at Sarangkot with our guide was magical. He knew exactly where to go to avoid the crowds.',
                host: 'Ramesh',
              ...
              },
              {
                name: 'James',
                review:
                  'Paragliding was intense but safe! Thanks to our local host for arranging everything seamlessly.',
                host: 'Bijay',
              ...
              },
              {
                name: 'Elena',
                review:
                  "We loved the food tour near Lakeside. The momos were the best I've ever had!",
                host: 'Kiran',
        ...
        <div className="mb-24" id="locals-section">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Meet our <span className="text-[#213448]">Pokhara locals</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Friendly guides ready to show you the magic of the lake city.
            </p>
          </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?w=400"
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Paragliding in Pokhara is a bucket-list experience. Take off from Sarangkot and
                  float over the Phewa Lake with the Annapurna range as your backdrop. It's an
                  adrenaline rush with the most peaceful view you can imagine.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Our local experts can arrange the best pilots and timing for you, ensuring a safe
            ...
            <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Rent a colorful 'doonga' (boat) and paddle out to the Tal Barahi Temple in the
                  middle of the lake. The reflection of Machhapuchhre mountain in the water is a
                  sight to behold, especially during sunset.
                </p>
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Pokhara is the adventure capital of Nepal and the gateway to the Annapurna Circuit.
              But it's also a place of deep relaxation. Whether you want to fly high in the sky or
              sit by the lake with a book, Pokhara has it all.
            </p>
            <p>
              Start your day with a hike to the{' '}
              <strong className="text-gray-900">World Peace Pagoda</strong> for a panoramic view of
              the valley. Then, explore the mysterious{' '}
              <strong className="text-gray-900">Mahendra Cave</strong> or the{' '}
              <strong className="text-gray-900">Davis Falls</strong> where the water vanishes
              underground.
            </p>
            <p>
              In the evening, Lakeside comes alive with live music, delicious food, and a vibrant
              atmosphere. Let our local guides show you the best spots to unwind and enjoy the
              nightlife.
            </p>
          </div>
        </div>
