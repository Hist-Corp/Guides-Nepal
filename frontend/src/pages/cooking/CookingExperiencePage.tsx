...
export const cookingExperiencesData: CookingExperience[] = [
  {
    id: 1,
    title: 'Authentic Nepali Cooking Class with Market Visit',
    slug: 'nepali-cooking-class-market-visit',
    heroImage:
      'https://images.unsplash.com/photo-1556910103-1c02745aae4d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    rating: 4.9,
    reviews: 892,
    price: 65,
    duration: '4 hours',
    ...
    guides: [
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=128&h=128&q=80',
        rating: 4.8,
        reviews: 567,
    ...
    exploration: {
      ...
      description:
        'This immersive cooking experience will teach you the fundamental techniques of Nepali cuisine while sharing stories about the cultural significance of each dish.',
      points: [
    ...
    atmosphere:
      'My kitchen is warm and welcoming, filled with the aromas of traditional spices. I create a relaxed environment where you can ask questions, take photos, and truly immerse yourself in Nepali cooking culture. We often share stories while cooking, and I love hearing about your own food traditions!',
    hiddenGems:
      "I'll share my grandmother's secret spice combinations that have been passed down through generations. You'll also learn about the medicinal properties of different herbs and how to adapt Nepali recipes using ingredients available in your home country.",
  },
  {
    id: 2,
    ...
    heroImage:
      'https://images.unsplash.com/photo-1617093727343-374698b1b08d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    rating: 4.8,
    reviews: 567,
    price: 45,
    duration: '3 hours',
    ...
    guides: [
      {
        ...
        image:
          'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=128&h=128&q=80',
        rating: 4.8,
        reviews: 567,
    ...
    description:
      "Master the art of Nepal's most beloved dish - momo dumplings! In this hands-on workshop, you'll learn to make perfect momo wrappers, create delicious fillings, and master the traditional folding techniques. From classic chicken momos to creative vegetarian variations.",
    tourStructure: {
      steps: [
    ...
    exploration: {
      ...
      description:
        'This specialized workshop focuses entirely on momo making, from basic techniques to advanced presentation skills.',
      points: [
    ...
    atmosphere:
      'My workshop space is casual and fun - we usually have music playing and share lots of laughs while folding momos. I encourage everyone to get creative with their folding styles and we often have friendly competitions for the most beautiful momo!',
    hiddenGems:
      "I'll teach you the secret to making momos that don't fall apart during steaming, plus my special spice blend that makes the fillings incredibly flavorful. You'll also learn how to freeze momos properly so you can enjoy them anytime!",
  },
];
...
const ReadMoreText = ({
  ...
  return (
    <div>
      ...
      <button onClick={() => setIsExpanded(!isExpanded)} className={buttonClassName}>
          ...
          <div className="lg:grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              <div id="guides-section" className="pb-8 border-b border-gray-100">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-sm text-gray-500 hidden md:block">
                    Select a chef to see their availability
                  </span>
                </div>
              ...
              <div className="prose prose-lg max-w-none text-gray-600">
                ...
                <div className="my-8 p-6 bg-orange-50 rounded-xl border border-orange-200">
                  <h3 className="text-orange-800 font-bold mb-2 uppercase text-sm tracking-wide">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-8">
                  ...
                  {!isBookingConfirmed ? (
                    ...
                    <div className="flex flex-col items-center text-center py-8 animate-in fade-in zoom-in duration-300">
                      ...
                      <p className="text-gray-500 text-sm mb-6">
                        Your cooking class has been reserved.
                      </p>
                ...
                {/* Similar Experiences */}
                <div>
                  <h3 className="font-bold text-xl text-gray-900 mb-6 border-b pb-2">
                    Similar cooking experiences
                  </h3>

                  <div className="space-y-6">
                    {cookingExperiencesData
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-gray-500 mb-8">
                  Complete the form below and we'll confirm your cooking class shortly.
                </p>
                ...
                <form className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        type="text"
                        className="w-full p-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-600 focus:border-transparent outline-none transition-all"
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      className="w-full p-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-600 focus:border-transparent outline-none transition-all h-32 resize-none"
                  ...
                  <button
                    type="button"
                    className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-full uppercase tracking-wider transition-all shadow-lg shadow-orange-600/30 flex items-center gap-2"
                  >
                    Send Request
                  </button>
                </form>
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="mt-8">
                    <h3 className="font-bold text-xl text-gray-900">
                      {selectedGuide ? selectedGuide.name : data.host.name}
                    </h3>
                    <p className="text-orange-600 font-medium">
                      {selectedGuide ? selectedGuide.role : data.host.type}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <ReadMoreText
                    text={
                      viewingGuide.bio ||
                      `I'm ${viewingGuide.name}, a passionate local chef who loves sharing the authentic flavors of Nepali cuisine. I believe cooking is the best way to connect with culture!`
                    }
                  />
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {viewingGuide.languages.map((lang: string, i: number) => (
                        <div
                          key={i}
                          className="flex items-center gap-2 px-4 py-2 bg-orange-100 rounded-lg text-orange-800 font-bold text-sm tracking-wide"
                        >
