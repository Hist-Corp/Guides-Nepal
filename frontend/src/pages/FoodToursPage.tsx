        ...
        setGuides([
          {
            ...
            rating: 4.9,
            reviews: 120,
            bio: 'Expert in Kathmandu Valley street food.',
          ...
          },
          {
            ...
            role: 'Newari Cuisine Expert',
            rating: 4.8,
            reviews: 89,
            bio: 'Specialist in traditional Newari cuisine.',
          ...
          },
          {
            ...
            role: 'Himalayan Flavors Guide',
            rating: 4.95,
            reviews: 156,
            bio: 'Expert in Himalayan regional cuisine.',
            languages: ['English', 'Nepali'],
            verified: true,
            livesIn: 'Pokhara',
          ...
          },
          {
            ...
            name: 'Rohan',
            image:
              'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=128&h=128&q=80',
            role: 'Terai Traditions Keeper',
            rating: 4.92,
            reviews: 78,
            bio: 'Specialist in Terai region traditions and cuisine.',
  ...
  const cultureCards = [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1567337710282-00832b415979?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    },
    {
      slug: 'sherpa',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1512058564366-18510be2db19?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    },
    {
      slug: 'tamang',
      ...
      image:
        'https://images.unsplash.com/photo-1466637574441-749b8f19452f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    },
    {
      slug: 'gurung',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1496116218417-1a781b1c416c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    },
    {
      slug: 'maithil',
      ...
      image:
        'https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    },
    {
      slug: 'thakali',
      ...
      image:
        'https://images.unsplash.com/photo-1585937421612-70a008356fbe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                Walk lively markets, follow hidden alleyways, and taste iconic dishes like momos,
                Newari feast bites, and Thakali thalis. Your local guide shapes the route around
                your pace and cravings.
              </p>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <button
                  onClick={() =>
                    document
                      .getElementById('culture-section')
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4 translate-y-8">
                  ...
                  <div className="aspect-square rounded-2xl overflow-hidden shadow-lg bg-[#E0F2FE] p-4 flex items-center justify-center text-center">
                    <div>
                      <div className="text-3xl font-bold text-[#213448] mb-1">
                        {cultureCards.length}
                      </div>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20 text-center">
          <div className="flex flex-col items-center group">
            ...
            <p className="text-gray-500 max-w-xs">
              Taste the stories behind Nepal’s everyday food.
            </p>
          </div>
          <div className="flex flex-col items-center group">
            <div className="w-20 h-20 rounded-full bg-[#FFF0E6] flex items-center justify-center text-[#213448] mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-gray-500 max-w-xs">
              Always private. It’s just you and your local guide.
            </p>
          </div>
          <div className="flex flex-col items-center group">
            <div className="w-20 h-20 rounded-full bg-[#FFF0E6] flex items-center justify-center text-[#213448] mb-6 group-hover:scale-110 transition-transform duration-300">
        ...
        <section id="guides-section" className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our guides are passionate foodies who will take you on a culinary journey through the
              heart of Nepal.
            </p>
          </div>
            ...
            {loading ? (
              ...
              guides.map((guide) => (
                <Link key={guide.name} to={`/local/${guide.id}`} className="text-center group">
                  ...
                  <h3 className="font-bold text-lg text-gray-900 group-hover:text-[#D2691E] transition-colors duration-300">
                    {guide.name}
                  </h3>
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">
                Explore by Ethnic Food Culture
              </h2>
              <p className="text-gray-600">
                Choose a culture to dive into its flavors, places, and stories
              </p>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                ...
                alt="Street Food Safari"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Street Food Safari</h3>
                <p className="text-gray-600 mb-4">
                  Dive into the heart of Kathmandu's vibrant street food scene. A private food tour
                  is the best way to discover the most delicious and authentic local snacks, from
                  savory samosas and momos to sweet jalebis and sel roti.
                </p>
                <p className="text-gray-600">
                  Let a local guide you through the bustling markets and hidden alleyways to taste
                  the true flavors of Nepal. It's an experience that will delight your senses and
                  leave you with a full belly.
                </p>
              </div>
            </div>
            {/* Card 2: Momo Mania */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  Momo Mania: A Dumpling Quest
                </h3>
                <p className="text-gray-600 mb-4">
                  Embark on a quest to find the best momos in Kathmandu! These delicious dumplings,
                  often filled with spiced meat or vegetables, are a Nepali obsession, and every
                  local has their favorite spot. Join a food tour to sample a variety of momos, from
                  traditional to modern twists.
                </p>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Taste the heart and soul of Nepali cuisine: Dal Bhat. This staple meal, consisting
                  of lentil soup, steamed rice, and various side dishes, is eaten daily by millions.
                  A food tour can introduce you to regional variations, from the rich Thakali thali
                  to simple homestyle versions.
                </p>
                <div className="bg-gray-100 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800 mb-2">What's in a Thali?</h4>
                  <p className="text-gray-600">
                    Dal (lentils), Bhat (rice), Tarkari (curry), Achar (pickle), and often a meat or
                    vegetable side.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                ...
                alt="Newari Culinary Journey"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Newari Culinary Journey</h3>
                <p className="text-gray-600 mb-4">
                  Explore the unique and flavorful cuisine of the Newar people, the indigenous
                  inhabitants of the Kathmandu Valley. A Newari food tour will take you to
                  traditional eateries to sample a wide array of dishes, from savory lentil pancakes
                  (wo) and sweet yomari dumplings to spicy buffalo meat (choila).
                </p>
                <div className="bg-yellow-100 p-4 rounded-lg">
                  <h4 className="font-bold text-yellow-800 mb-2">MUST TRY</h4>
                  <p className="text-yellow-700">
                    Try a traditional Newari feast (Bhoj) for the full experience!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                ...
                alt="Thakali Thali Trail"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Thakali Thali Trail</h3>
                <p className="text-gray-600 mb-4">
                  Taste why Thakali dal‑bhat became famous across Nepal: clean, balanced flavors,
                  comforting lentils, fluffy rice, seasonal greens, and a bright lineup of achars
                  that wake up every bite.
                </p>
                <div className="bg-gray-100 p-4 rounded-lg">
                  <h4 className="font-bold text-gray-800 mb-2">LOOK FOR</h4>
                  <p className="text-gray-600">
                    Tangy pickles, gundruk, and that perfect lentil aroma.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1740&q=80"
                alt="Himalayan Noodle Bowls"
                className="w-full h-64 object-cover"
              />
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Himalayan Noodle Bowls</h3>
                <p className="text-gray-600 mb-4">
                  Warm up with Sherpa and Tibetan‑Nepali comfort food: thukpa and thenthuk broths,
                  dumplings, and teahouse bites that reflect trade routes, altitude life, and
        ...
        <div className="bg-white py-20">
          <div className="max-w-4xl mx-auto text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Best food tour experiences in Nepal
            </h2>
            <div className="text-gray-600 space-y-4">
              ...
              <p>
                Start your culinary journey with a Street Food Safari, diving into the heart of
                Kathmandu's vibrant food scene. This is the best way to discover authentic local
                snacks, from savory samosas to sweet jalebis, guided by a local expert.
              </p>
              <p>
                If you're a fan of dumplings, you're in for a treat! Momo Mania is an art form in
                Nepal. These juicy dumplings, filled with spiced meat or vegetables, are a national
                obsession. A food tour will take you to the best spots to taste them, steamed,
                fried, or in a spicy soup.
              </p>
              <p>
              ...
              <p>
                ...
                discover in Nepal. And with a Guides Nepal food tour, you can customize your
                experience to focus on your favorite flavors. So what are you waiting for? Book your
                private food tour today and discover the magic of Nepali cuisine!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                'Hands-on food tour',
                'Nepali kitchen secrets',
                'Traditional food methods',
                'Nepali family meals',
                'Cultural food experience',
                'Nepali spices',
                'Kathmandu culinary adventure',
                'Food vacation Nepal',
                'Food tour Kathmandu',
                ...
                <button
                  key={index}
                  className="px-4 py-2 bg-white border border-gray-300 rounded-full text-gray-700 hover:bg-gray-100 transition-colors"
                >
                  {keyword}
                </button>
              ))}
        ...
        {/* Explore More Categories — cross-links to the other category pages */}
            ...
            {[
              {
                ...
                description: 'Heritage walks, temples & living traditions',
                image: NEPAL_IMAGES.heritage,
                path: '/cultural-tours',
              },
              {
                title: 'Outdoor Activities',
                description: 'Treks, safaris, rafting & adventure',
                image: NEPAL_IMAGES.trekking,
                path: '/outdoor-activities',
              },
              {
                title: 'Cooking Classes',
                description: 'Hands-on classes with local home chefs',
                image: NEPAL_IMAGES.cookingClass,
                path: '/cooking-classes',
              },
              {
                title: 'Most Popular',
                description: 'The experiences travelers book most',
              ...
              <Link
                key={cat.path}
                to={cat.path}
                className="group relative rounded-2xl overflow-hidden h-56 block shadow-md hover:shadow-xl transition-all duration-300"
              >
                <img
                  src={cat.image}
                  alt={cat.title}
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <p className="text-white/85 text-sm">{cat.description}</p>
                </div>
              </Link>
            ))}
          </div>
        ...
        <section className="bg-[#213448] rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of food lovers who've discovered Nepal through its incredible cuisine
          </p>
