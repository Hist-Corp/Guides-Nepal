...
const experienceGrid = [
  ...
  },
  {
    ...
    guide: {
      name: 'Sina',
      image:
        'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=80&h=80&q=80',
    },
      ...
      <main>
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    <Link to={item.link} className="flex-1">
                      <Button
                        size="sm"
                        className="w-full bg-primary hover:bg-primary-hover text-white text-xs font-bold py-2 border-none"
                      >
                        Read more
                      </Button>
                    </Link>
                    <Link to={item.link} className="flex-1">
                      <Button
                        size="sm"
                        variant="outline"
                        className="w-full border-primary text-primary hover:bg-primary/5 text-xs font-bold py-2"
                      >
                        Book now
                      </Button>
                    </Link>
        ...
        <section className="py-12 container mx-auto px-4">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-2">
              <button className="p-1.5 rounded-full border border-gray-200 hover:border-primary hover:text-primary transition-colors">
            ...
            {popularDestinations.map((dest, i) => (
              ...
              >
                <div className="rounded-xl overflow-hidden aspect-square mb-2 relative">
                  ...
                  <span className="absolute bottom-2 left-3 text-white font-bold text-sm shadow-black drop-shadow-md">
                    {dest.name}
                  </span>
                </div>
              </Link>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex gap-2">
                <button className="p-2 rounded-full border border-gray-200 bg-white hover:border-primary hover:text-primary transition-colors">
                  <ChevronLeft className="w-5 h-5" />
                </button>
                <button className="p-2 rounded-full border border-gray-200 bg-white hover:border-primary hover:text-primary transition-colors">
                  <ChevronRight className="w-5 h-5" />
                ...
                <div key={i} className="group cursor-pointer">
                  <div className="relative rounded-2xl overflow-hidden aspect-[3/4] mb-3">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center p-4">
                      <Button size="sm" className="bg-primary text-white border-none text-xs">
                        View Profile
                      </Button>
                    </div>
                  </div>
