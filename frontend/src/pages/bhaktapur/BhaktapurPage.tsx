          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                Step back in time in <span className="text-[#213448]">Bhaktapur</span>{' '}
                <br className="hidden md:block" />
                with our locals
              </h1>

              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                The City of Devotees. Explore medieval squares, try pottery making, and taste the
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg rounded-bl-[4rem]">
                    <img
                      src="https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=400&q=80"
                      alt="Local Guide"
                      className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                    />
                  </div>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
            ...
            {[
              {
                name: 'David',
                review:
                  'The pottery class was so much fun! My bowl was a bit wonky, but I loved the experience.',
                host: 'Radha',
              ...
              },
              {
                name: 'Jennifer',
                review:
                  'Juju Dhau is truly the King of Curd. Thanks to Prakash for taking us to the best spot!',
                host: 'Prakash',
              ...
              },
              {
                name: 'Robert',
                review:
                  "Walking through Bhaktapur felt like time travel. Krishna's stories made it come alive.",
                host: 'Krishna',
        ...
        <div className="mb-24" id="locals-section">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Meet our <span className="text-[#213448]">Bhaktapur locals</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Friendly guides ready to show you the magic of the medieval city.
            </p>
          </div>
        ...
        <div className="mb-24">
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="md:w-1/2">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Spin the Wheel at Pottery Square
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Bhaktapur is famous for its clay crafts. Visit the Pottery Square where hundreds
                  of pots are laid out to dry in the sun. It's a photographer's dream and a chance
                  to see a tradition that hasn't changed for centuries.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Don't just watch! Join a workshop with a local potter and try your hand at shaping
                  the clay on a traditional wheel.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?auto=format&fit=crop&w=400&q=80"
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Juju Dhau, or "King Curd", is a sweet, creamy yogurt unique to Bhaktapur. Made
                  from buffalo milk and set in clay pots, it has a distinct flavor you won't find
                ...
                <div className="bg-[#FFF0E6] p-6 rounded-2xl border-l-4 border-[#213448]">
                  ...
                  <p className="text-sm text-gray-700">
                    Look for the shops with the red flags - they usually serve the freshest curd.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Bhaktapur is known as the 'City of Devotees' and for good reason. It has the
              best-preserved medieval city center in Nepal. No cars are allowed in the main squares,
              making it a pleasure to explore on foot.
            </p>
            <p>
              The <strong className="text-gray-900">Nyatapola Temple</strong> is the tallest pagoda
              in Nepal and a stunning example of Newari engineering. The{' '}
              <strong className="text-gray-900">55-Window Palace</strong> in Durbar Square is a
              masterpiece of wood carving.
            </p>
            <p>
              Take your time to wander through the narrow alleys, watch the locals go about their
              daily life, and soak in the timeless atmosphere of this ancient city.
            </p>
          </div>
        </div>
