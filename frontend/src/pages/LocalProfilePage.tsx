  ...
  const portfolioHighlights = [
    {
      ...
      date: 'April 2023',
      image:
        'https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?auto=format&fit=crop&w=1740&q=80',
      description:
        'Led a group of 12 trekkers to EBC. Successfully managed altitude acclimatization for all members. 100% summit success rate for Kalapatthar.',
    },
    {
      ...
      description:
        'Assisted a film crew in locating authentic cultural spots in Bhaktapur and Patan. Managed logistics and translation for interviews with local artisans.',
    },
    {
      ...
      date: 'Jan 2024',
      image:
        'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=1740&q=80',
      description:
        'Conducted a workshop for new guides on sustainable trekking practices and waste management in the Himalayas.',
    },
  ];

  // Find tours offered by this guide across ALL cities
  const myTours = allExperiences.filter((tour) => tour.guides?.some((g) => g.id === guide.id));
              ...
              <div className="sticky top-24 space-y-6">
                <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-[#213448] font-bold text-xs uppercase tracking-wide mb-3">
                      {guide.role}
                    </p>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1 mt-0.5">
                            {guide.cities.map((city) => (
                              <span
                                key={city}
                                className="bg-[#213448]/10 text-[#213448] text-[10px] px-1.5 py-0.5 rounded font-bold"
                              >
                                {city}
                              </span>
                            ))}
            ...
            <div className="lg:w-2/3 space-y-12">
              ...
              <section>
                ...
                <div className="prose prose-lg text-gray-600 max-w-none">
                  ...
                  <p>
                    I love meeting new people and showing them the hidden gems of my city. Whether
                    you are a foodie, a history buff, or just looking for a good time, I can
                    customize the perfect experience for you.
                  </p>

                  {isBioExpanded && (
                    <div className="mt-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                      <p>
                        Growing up in Nepal has given me a deep appreciation for our rich culture
                        and traditions. I've spent years exploring every corner of the valley,
                        finding the best local eateries, ancient temples that aren't on the tourist
                        maps, and viewpoints with the most breathtaking sunrises.
                      </p>
                      <p>
                        My goal is to make you feel like a local, not just a tourist. We'll navigate
                        the bustling markets together, share stories over cups of masala chai, and
                        create memories that you'll cherish long after you leave. I'm flexible and
                        happy to adjust our plans based on your interests and pace.
                      </p>
                      <p>
                        Safety and comfort are my top priorities. I'm trained in first aid and know
                        the city inside out. Let's embark on an adventure that goes beyond the
                        guidebooks!
                      </p>
                    </div>
                  )}
              ...
              <section className="border-t border-gray-100 pt-12">
                ...
                <div className="space-y-8">
                  {portfolioHighlights.map((item, index) => (
                    <div
                      key={index}
                      className="flex flex-col md:flex-row gap-6 bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow"
                    >
                      ...
                      <div className="p-6 md:w-2/3 flex flex-col justify-center">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-[#213448] font-bold text-xs uppercase tracking-wide">
                            {item.role}
                          </span>
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2 mt-0 leading-tight">
                          {item.title}
                        </h3>
                ...
                <div className="my-12">
                  ...
                  <blockquote className="border-l-4 border-[#213448] pl-4 italic text-gray-700 bg-gray-50 p-4 rounded-r-lg">
                    "Travel is not just about seeing new places; it's about feeling them. I believe
                    in sustainable tourism that respects local communities and preserves our
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {guide.gallery.slice(1).map((img, i) => (
                      <div
                        key={i}
                        className="aspect-[4/3] rounded-xl overflow-hidden cursor-pointer hover:opacity-90 transition-opacity shadow-sm"
                      >
                        <img
                          src={img}
                          alt={`Gallery ${i}`}
              ...
              <section>
                ...
                <p className="text-gray-500 mb-8">
                  Check out the personalized tours I can offer you across Nepal. Each experience can
                  be 100% tailored to your wishes!
                </p>
                  ...
                  {myTours.length > 0 ? (
                    ...
                    <div className="text-center py-12 bg-white rounded-2xl border border-dashed border-gray-300">
                      <p className="text-gray-500">
                        No specific offers listed yet. Contact me for a custom tour!
                      </p>
                    </div>
                  )}
                </div>
              ...
              <section className="bg-secondary/10 rounded-2xl p-8 text-center relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Share your experience with the community! Your review helps others find the best
                    local guides.
                  </p>
                  <button
                  ...
                  {[
                    {
                      name: 'Sarah J.',
                      date: 'October 2025',
                      text: 'Absolutely amazing experience! The food was incredible and the stories were even better.',
                      rating: 5,
                    },
                    {
                      name: 'Mike T.',
                      date: 'September 2025',
                      text: 'We felt like we were walking around with a friend. Highly recommend!',
                      rating: 5,
                    },
                    {
                      name: 'Emma W.',
                      date: 'August 2025',
                      text: 'Such a knowledgeable guide. We learned so much about the local culture.',
                      rating: 5,
                    },
                  ].map((review, i) => (
              ...
              <section className="space-y-6 pt-8 border-t border-gray-200">
                ...
                <div className="rounded-2xl overflow-hidden relative aspect-video group cursor-pointer">
                  <img
                    src="https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=1740&q=80"
              ...
              <section className="bg-[#570D46] rounded-2xl p-8 md:p-12 text-white relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="relative z-10 max-w-md">
                  <h2 className="text-2xl md:text-3xl font-bold mb-4">
                    Connect with locals wherever and whenever!
                  </h2>
                  <p className="text-white/80 mb-8">
                    Get the app to become part of the fastest growing travel community. Join now &
                    pull up a chair at the table with our hosts, friends and chefs!
                  </p>
            ...
            <div className="p-6">
              ...
              <form
                ...
                onSubmit={(e) => {
                  ...
                  alert(
                    `Thank you for your ${selectedRating}-star review! It will be posted after moderation.`
                  );
            ...
            <div className="p-6 space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Only travelers who have booked and completed a tour with this guide can leave a
                    review. This ensures all feedback is authentic.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    We moderate reviews to ensure they follow our community guidelines. We don't
                    edit the content, but we remove spam or abusive language.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Guides are rated on knowledge, friendliness, and service quality. The overall
                    score is a weighted average of all past reviews.
                  </p>
                </div>
              </div>
