...
export const BharatpurPage: React.FC = () => {
  ...
  const bharatpurGuides = allGuides.filter(
    (g) => g.cities?.includes('Bharatpur') || g.cities?.includes('Chitwan')
  );
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                Go wild in <span className="text-[#213448]">Bharatpur</span>{' '}
                <br className="hidden md:block" />
                with our locals
              </h1>

              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                The Gateway to Chitwan. Experience jungle safaris, Tharu culture, and the serenity
                of the Rapti River.
              </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
            ...
            {[
              {
                name: 'Sarah',
                review:
                  'Seeing a rhino in the wild was a dream come true! Our guide Ram was so knowledgeable.',
                host: 'Ram',
        ...
        <div className="mb-24" id="locals-section">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Meet our <span className="text-[#213448]">Bharatpur locals</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Jungle experts and cultural ambassadors ready to share their world.
            </p>
          </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?auto=format&fit=crop&w=400&q=80"
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Chitwan National Park is one of the best places in Asia to see wildlife. Jump in a
                  jeep and explore the dense forests and grasslands. Keep your eyes peeled for the
                  majestic Royal Bengal Tiger and the One-Horned Rhinoceros.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Our local guides know the park like the back of their hand and can take you to the
            ...
            <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  The Tharu people are the indigenous inhabitants of the Terai region. Their unique
                  culture, language, and traditions are fascinating. Watch their traditional stick
                  dance, visit their mud houses, and try their local cuisine.
                </p>
                <div className="bg-[#FFF0E6] p-6 rounded-2xl border-l-4 border-[#213448]">
                  ...
                  <p className="text-sm text-gray-700">
                    Don't miss the evening cultural show in Sauraha.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Bharatpur is the fourth largest city in Nepal and the gateway to the world-famous
              Chitwan National Park. It's a city where urban life meets the wild jungle.
            </p>
            <p>
              The <strong className="text-gray-900">Chitwan National Park</strong> is a UNESCO World
              Heritage site and home to some of the world's most endangered species.{' '}
              <strong className="text-gray-900">Narayani River</strong> offers beautiful sunsets and
              boating opportunities.
            </p>
            <p>
              Visit <strong className="text-gray-900">Devghat Dham</strong>, a holy pilgrimage site,
              or explore the <strong className="text-gray-900">Bishazari Tal</strong> (20,000 Lake)
              for bird watching. Bharatpur has something for every nature lover.
            </p>
          </div>
        </div>
