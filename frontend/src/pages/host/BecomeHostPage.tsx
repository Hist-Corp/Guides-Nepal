  ...
  const faqs = [
    {
      ...
      answer:
        'An experience is an activity that goes beyond the typical tour or class, designed and led by locals all over the world. Show off your city, craft, cause, or culture by hosting an experience.',
    },
    {
      question: 'What can I host?',
      answer:
        'You can host a food tour, a workshop, a city walk, a day trip, or any unique activity that shares your passion and local knowledge.',
    },
    {
      question: 'Do I need to be an experienced host?',
      answer:
        'No! You just need passion for your city and a desire to meet new people. We provide the tools and support to help you succeed.',
    },
    {
      question: 'Do I need insurance?',
      answer:
        'We recommend checking your local regulations. However, Guides Nepal provides liability insurance for most experiences hosted on our platform.',
    },
    {
      question: 'How do I get paid?',
      answer:
        'We offer secure payouts directly to your bank account or via other payment methods, processed shortly after the experience takes place.',
    },
    {
      question: 'Is it safe to host travelers?',
      answer:
        'Safety is our priority. We verify travelers and hosts, and our review system builds trust within the community.',
    },
  ];
      ...
      <main className="flex-grow">
        ...
        <section className="relative h-[600px] flex flex-col items-center pt-20 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center mt-10">
            ...
            <p className="text-lg md:text-xl text-slate-700 mb-8 font-medium">
              <span className="text-brand-yellow font-bold">#GuidesNepal</span> helps you turn your
              passion into income.
            </p>
        ...
        <section className="py-24 bg-[#FFF8F0]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <span className="text-brand-yellow font-bold border-b-2 border-brand-yellow pb-1 uppercase tracking-wider text-sm">
                Earn money
              </span>
              <h2 className="text-3xl md:text-4xl font-bold mt-6 mb-4">
                Earn money doing what you love in your city
              </h2>
              <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                Guides Nepal lets you share your local knowledge and passions by creating unique
                experiences for travelers. Set your own schedule and earn money doing what you love.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-xl transition-shadow text-center group"
                >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-6 mb-4">
                Thousands of local hosts. One global community.
              </h2>
              ...
              {[
                {
                  name: 'Mina Gloria',
                  quote:
                    "When I host with Guides Nepal, I feel like I'm traveling the world right from my own city. I've made friends from everywhere!",
                  img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&q=80',
                },
                {
                  name: 'Jaafar',
                  quote:
                    "Guides Nepal allows me to show the real side of my city. I'm proud to be part of it and share my culture.",
                  img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80',
                },
                {
                  name: 'Zsofia',
                  quote:
                    'Hosting with Guides Nepal feels like doing what I love, not just a job. The flexibility is amazing for my lifestyle.',
                  img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=100&q=80',
                },
              ].map((host, i) => (
                <div
                  key={i}
                  className="relative group overflow-hidden rounded-3xl h-96 shadow-lg cursor-pointer"
                >
                  <img
                    src={host.img}
                    alt={host.name}
        ...
        <section className="py-24 bg-[#FFF8F0]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-6 mb-4">
                Start hosting fast with Guides Nepal Originals!
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                Ready-made experiences you can personalize and launch quickly. No need to start from
                scratch!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="bg-white rounded-3xl overflow-hidden shadow-xl hover:-translate-y-2 transition-transform duration-300 flex flex-col"
                >
            ...
            <div className="text-center mt-12">
              <a
                href="#"
                className="text-brand-yellow font-bold hover:underline inline-flex items-center gap-2"
              >
                Looking for your own idea? Apply now to launch your Original!{' '}
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mt-6 mb-16">
                One platform. All the tools to succeed.
              </h2>
            </div>
              ...
              {[
                {
                  icon: <Calendar />,
                  title: 'Set your own schedule',
                  desc: 'Host at times that suit you.',
                },
                {
                  icon: <Globe />,
                  title: 'Work from anywhere',
                  desc: 'Host in your city and manage on the go.',
                },
                {
                  icon: <Sparkles />,
                  title: 'Create unique experiences',
                  desc: 'Design and customize your offerings.',
                },
                {
                  icon: <Zap />,
                  title: 'Get paid fast',
                  desc: 'Secure payouts with reliable systems.',
                },
                {
                  icon: <Shield />,
                  title: "We've got your back",
                  desc: 'Support when things go wrong.',
                },
                {
                  icon: <Star />,
                  title: 'Grow your audience',
                  desc: 'Marketing to help travelers discover you.',
                },
                {
                  icon: <CheckCircle2 />,
                  title: 'Build trust with reviews',
                  desc: 'A transparent rating system.',
                },
                {
                  icon: <Facebook />,
                  title: 'Expert guidance',
                  desc: 'Get tips and best practices from our team.',
                },
              ].map((item, i) => (
        ...
        <section id="apply-form" className="py-24 bg-slate-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center text-white">
            ...
            <h2 className="text-4xl md:text-6xl font-bold mt-8 mb-10">
        ...
        <section className="py-24 bg-[#FFF8F0]">
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="text-center mb-16">
              <span className="text-[#213448] font-bold border-b-2 border-[#213448] pb-1 uppercase tracking-wider text-sm">
                Questions?
              </span>
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  >
                    {faq.question}
                    {openFaq === i ? (
                      <ChevronUp className="w-5 h-5 text-[#213448]" />
                    ) : (
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-sm text-gray-500 font-medium">
              {[
                ...
                <a key={i} href="#" className="hover:text-brand-yellow transition-colors">
                  {city}
                </a>
              ))}
            </div>
