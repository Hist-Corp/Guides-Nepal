...
export const outdoorActivities = [
  {
    ...
    price: 899,
    image:
      'https://images.unsplash.com/photo-1544735716-392fe2489ffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg group cursor-pointer mb-12">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <p className="text-xl">
                From mountain peaks to jungle valleys, discover Nepal's natural wonders.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                Skip the tourist traps and get the authentic outdoor experience. Explore mountains,
                jungles, and rivers with a friendly guide who shows you the hidden gems & main
                highlights.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4 translate-y-8">
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg">
                    <img
                      src="https://images.unsplash.com/photo-1519681393784-d120267933ba?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80"
                      alt="Mountain Guide"
                ...
                <div className="space-y-4">
                  <div className="aspect-square rounded-2xl overflow-hidden shadow-lg">
                    <img
                      src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80"
                      alt="Jungle Safari"
                      className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                    />
                  </div>
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg rounded-bl-[4rem]">
                    <img
                      src="https://images.unsplash.com/photo-1502602898657-3e91760cbb34?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80"
                      alt="Adventure Guide"
                      className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                    />
                  </div>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
            ...
            {[
              {
                name: 'Sarah',
                review:
                  'Tenzin was an incredible guide for our Everest Base Camp trek. His knowledge of the mountains and local culture made the journey unforgettable. Highly recommended!',
                host: 'Tenzin',
              ...
              },
              {
                name: 'Michael',
                review:
                  "Pema took us on an amazing Annapurna Circuit trek. The views were spectacular and Pema's expertise ensured we had a safe and enjoyable experience.",
                host: 'Pema',
              ...
              },
              {
                name: 'Emma',
                review:
                  "Dorje's jungle safari in Chitwan was incredible! We saw rhinos, tigers, and so many birds. His passion for wildlife conservation was inspiring.",
                host: 'Dorje',
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                    <div className="flex -space-x-2">
                      {activity.locals.map((l, i) => (
                        <img
                          key={i}
                          src={`https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=80&h=80&q=80`}
        ...
        <div className="mb-24 pt-16 border-t border-gray-100">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-[#213448]">
              Why do Guides Nepal hosts love what they do?
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              ...
              },
              {
                ...
                desc: 'Sharing their love for the outdoors.',
              ...
              {
                title: 'Unique skills',
                desc: 'From mountain guides to wildlife experts.',
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#213448] mb-6">
            Best outdoor adventures in Nepal
          </h2>
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Nepal is an outdoor enthusiast's paradise! From the towering peaks of the Himalayas to
              the lush jungles of the Terai, this country offers endless opportunities for adventure
              and exploration. Whether you're seeking high-altitude trekking, wildlife encounters,
              or adrenaline-pumping sports, Nepal has it all.
            </p>
            <p>
              Start your outdoor adventure with{' '}
              <strong className="text-gray-900">trekking in the Himalayas</strong>. The{' '}
              <strong className="text-gray-900">Everest Base Camp</strong> and{' '}
              <strong className="text-gray-900">Annapurna Circuit</strong> are world-famous routes
              that offer breathtaking mountain views and cultural experiences with local
              communities.
            </p>
            <p>
              For wildlife lovers, <strong className="text-gray-900">Chitwan National Park</strong>{' '}
              provides incredible safari experiences. Spot endangered one-horned rhinos, Bengal
              tigers, and hundreds of bird species while learning about conservation efforts from
              local guides.
            </p>
            <p>
              Adventure seekers can enjoy{' '}
              <strong className="text-gray-900">paragliding in Pokhara</strong>,{' '}
              <strong className="text-gray-900">white-water rafting</strong> on Himalayan rivers, or{' '}
              <strong className="text-gray-900">rock climbing</strong> in the Kathmandu Valley. Each
              activity offers unique perspectives of Nepal's diverse landscapes.
            </p>
            <p>
              No matter what outdoor activity you choose, experiencing Nepal with a local guide
              ensures safety, cultural insights, and access to hidden gems off the beaten path. Book
              your private outdoor adventure today and discover the natural wonders of Nepal!
            </p>
          </div>
        </div>
      </main>
