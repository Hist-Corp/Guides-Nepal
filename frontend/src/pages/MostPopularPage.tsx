...
const experiencesData = {
  '103': {
    ...
    price: 20,
    images: [
      'https://images.unsplash.com/photo-1548013146-72479768bada?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    ],
  ...
  '201': {
    ...
    price: 90,
    images: [
      'https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    ],
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600">
            Discover the tours and activities that travelers love the most.
          </p>
        </div>
