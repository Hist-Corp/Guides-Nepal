...
export const culturalTours = [
  {
    ...
    price: 37,
    image:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Swayambhu%2C_Kathmandu%2C_Nepal.jpg/960px-Swayambhu%2C_Kathmandu%2C_Nepal.jpg',
    locals: ['Araya'],
  ...
  },
  {
    ...
    price: 49,
    image:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Thamel_Kathmandu_Nepal.jpg/960px-Thamel_Kathmandu_Nepal.jpg',
    locals: ['Artty', 'Sammy'],
  ...
  },
  {
    ...
    price: 35,
    image:
      'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
  ...
  },
  {
    ...
    price: 137,
    image:
      'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80',
    locals: ['Jojo', 'Kung'],
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
                Skip the tourist traps and get the authentic cultural experience. Explore ancient
                temples, monasteries, and traditions with a friendly guide who shows you the hidden
                gems & main highlights.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  <div className="aspect-square rounded-2xl overflow-hidden shadow-lg">
                    <img
                      src="https://images.unsplash.com/photo-1516280440614-37939bbacd81?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&h=800&q=80"
                  ...
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg rounded-bl-[4rem]">
                    <img
                      src="https://images.unsplash.com/photo-1545126178-862cdb469409?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80"
                      alt="Local Guide"
                      className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                    />
                  </div>
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex -space-x-3">
                        <img
                          src={`https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=100&h=100&q=80`}
            ...
            {[
              {
                name: 'Racquel',
                review:
                  'Highly enthusiastic sharing Nepali culture, great food selections where locals eat, very kind, and our family sure enjoyed her company! Thank you Araya♥️',
                host: 'Araya',
              ...
              },
              {
                name: 'Bartek',
                review:
                  'Araya was wonderful and clearly knew what she was talking about. She created a personalised tour and all the food places she picked were delicious.',
                host: 'Araya',
                date: 'Kathmandu, January 21, 2026',
              },
              {
                name: 'Sammy',
                review:
                  'Sammy gave us a Great Tour through some hotspots of Kathmandu. He was very flexible and listened to us attentively. The answers to questions were always elaborate.',
                host: 'Sammy',
        ...
        <div className="mb-24" id="locals-section">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Explore Nepal with our <span className="text-[#213448]">incredible locals</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Learn about their personal stories and find out how you can explore Nepal with locals
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                    <div className="flex -space-x-2">
                      {tour.locals.map((l, i) => (
                        <img
                          key={i}
                          src={`https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=80&h=80&q=80`}
        ...
        <div className="mb-24">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="px-5 py-2.5 rounded-full border border-gray-200 hover:border-[#213448] hover:bg-[#213448] hover:text-white cursor-pointer transition-all bg-white text-gray-600 font-medium text-sm"
              >
                {cat}
              </div>
            ))}
        ...
        <div className="mb-24 text-center max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#213448] mb-6">
            Best cultural experiences in Nepal
          </h2>
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            <p>
              Nepal is a cultural treasure trove that will enrich your understanding of ancient
              traditions! The spiritual atmosphere, the colorful temples, the sacred rituals, and
              the knowledgeable locals. There are so many cultural experiences in Nepal, and with a
              local host, you can discover them all!
            </p>
            <p>
              Start your cultural journey at{' '}
              <strong className="text-gray-900">Kathmandu Durbar Square</strong>, a UNESCO World
              Heritage site. Here you can see ancient royal palaces, temples, and learn about the
              history of the Malla kings. Don't miss{' '}
              <strong className="text-gray-900">Swayambhunath Stupa</strong>, also known as the
              Monkey Temple, where you can observe Buddhist rituals and enjoy panoramic views.
            </p>
            <p>
              If you're interested in Buddhism, you're in for a treat! Nepal is the birthplace of
              Buddha. Visit <strong className="text-gray-900">Boudhanath Stupa</strong>, one of the
              largest spherical stupas in Nepal, or take a meditation session with local monks. Your
              local host can arrange authentic cultural experiences away from tourist crowds.
            </p>
            <p>
              Want to experience living culture? Participate in a{' '}
              <strong className="text-gray-900">traditional ceremony</strong> or festival. Learn
              about Hindu rituals, witness traditional dances, or visit local artisan workshops.
              These immersive experiences will give you deep insights into Nepali culture.
            </p>
            <p>
              No matter what aspect of culture interests you, there's always a cultural experience
              in Nepal. And with a Guides Nepal tour, you can customize your cultural journey to fit
              your interests perfectly. So what are you waiting for? Book your private cultural tour
              today and discover the rich heritage of Nepal!
            </p>
          </div>
        </div>
      </main>
