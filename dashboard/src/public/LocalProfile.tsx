...
export default function LocalProfile() {
  ...
  const theirExperiences = guide
    ? experiences.filter((e) => e.city === guide.city).slice(0, 3)
    : [];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="rounded-2xl bg-white border border-gray-200 p-8 flex flex-col sm:flex-row gap-6">
        <img
          src={guide.image ?? DEFAULT_GUIDE_IMAGE}
          alt={guide.name}
        ...
        <div className="flex-1">
          ...
          <div className="text-gray-500 text-sm mt-1">
            📍 {guide.city} · 🗣️ {guide.languages.join(', ')} · 🗓️ {guide.yearsExperience} years of
            experience
          </div>
