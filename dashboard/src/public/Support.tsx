...
export default function SupportPage() {
  ...
  return (
    <PageShell
      title="Get Support"
      description="Have a question or ran into an issue? Drop us a ticket and our support team will get back to you."
      noCard
    >
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-8">
        <div className="rounded-2xl bg-white border p-6">
          <div className="flex items-center gap-3 mb-2">
            <HelpCircle size={28} className="text-darkBlue" />
            <h1 className="text-2xl font-bold text-darkBlue">Raise a support ticket</h1>
          </div>
          <p className="text-gray-600 text-sm mb-6">
            Tell us what's going on and how we can help. We usually reply within one working day.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field
                ...
                value={email}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)}
                error={email.trim() && !hasEmail ? "Enter a valid email address" : undefined}
              />
            </div>
            <div>
              <label className="text-sm font-medium text-gray-700 block mb-1.5">Priority</label>
